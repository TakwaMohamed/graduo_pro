...
for page_number in range(458, total_pages + 1):
    url = f"{base_url}{page_number}?words=true&word_fields=v2_page,location,text_uthmani,codeV2&fields=text_uthmani_simple"
